        ...
        <div class="col-md-10">
            <div>
                <div class=" text-black text-center mb-6">
                    <h3 class="mb-0">Welcome to Payroll System, {{ Auth::user()->name }}!</h3>
                </div>
            </div>
        </div>
    </div>
...
<div class="row g-4 ml-2">
    ...
    <div class="col-md-3">
        <div class="card shadow-lg bg-success text-white hover-card card-documentations">
        <div class="icon-container">
            <i class="fas fa-user-graduate"></i>
        </div>
            <div class="card-body text-center">
                <h2 class="display-4">{{ $totalDocumentations }}</h2>
                <h4 class="lead">Documentations</h4>
            </div>
            <div class="border-top">
                <a href="{{ route('documentations.index') }}" class="text-decoration-none text-white p-3 d-block text-center">
                    View Documentations <i class="fas fa-arrow-right"></i>
                </a>
            </div>
        </div>
    </div>
    ...
    <!-- Total Departments -->
    <div class="col-md-3">
        <div class="card shadow-lg bg-primary text-white hover-card card-departments">
        <div class="icon-container">
            <i class="fas fa-laptop-house"></i>
        </div>
            <div class="card-body text-center">
                <h2 class="display-4">{{ $totalAttendances }}</h2>
                <h4 class="lead">Attendances</h4>
            </div>
            <div class="border-top">
                <a href="{{ route('attendances.index') }}" class="text-decoration-none text-white p-3 d-block text-center">
                    View Attendances <i class="fas fa-arrow-right"></i>
                </a>
            </div>
        </div>
    </div>
...
<div class="col-md-3">
    ...
    <div class="row g-3 mt-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-lg">
                <div class="card-header bg-warning text-dark text-center">
                    <h4>Employees vs Department</h4>
                </div>
                <div class="card-body">
                    <canvas id="employeesDepartmentChart" width="400" height="200"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-lg">
                <div class="card-header bg-danger text-white text-center">
                    <h4>Documentations vs Attendances</h4>
                </div>
                <div class="card-body">
                    <canvas id="documentationsAttendancesChart" width="400" height="200"></canvas>
                </div>
            </div>
        </div>
    </div>
...
<script>
    // Employees vs Departments Chart
    new Chart(document.getElementById('employeesDepartmentChart').getContext('2d'), {
        type: 'pie',
        data: {
            labels: ['Employees', 'Department'],
            datasets: [{
                data: [{{ $totalEmployees }}, {{ $totalDepartments }}],
    ...
    new Chart(document.getElementById('documentationsAttendancesChart').getContext('2d'), {
        type: 'pie',
        data: {
            labels: ['Documentations', 'Attendances'],
            datasets: [{
                data: [{{ $totalDocumentations }}, {{ $totalAttendances }}],
                backgroundColor: ['#36a2eb', '#ff6384'],
                borderColor: ['#36a2eb', '#ff6384'],
                borderWidth: 1
            }]
